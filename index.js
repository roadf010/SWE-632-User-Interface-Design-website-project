...
searchInput.addEventListener("input", (e) => {
    ...
    if (value == "" || value == null || !(value.includes("+") || value.includes("-") || value.includes("*") || value.includes("/") || value.includes("^") || parseFloat(value) != NaN || parseFloat(value) != undefined)){
        calculations.forEach(calc =>{
            calc.element.classList.toggle("hide", true)
        })
    } 
    else if (value.includes("+") || value.includes("-") || value.includes("*") || value.includes("/") || value.includes("^")|| parseFloat(value) != NaN || parseFloat(value) != undefined){
        calculations.forEach(calc =>{
