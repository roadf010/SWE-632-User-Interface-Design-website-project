...
searchInput.addEventListener("input", (e) => {
    ...
    if (value == "" || value == null || !(value.includes("+") || value.includes("-") || value.includes("*") || value.includes("/") || value.includes("^") || matches != null)){
        calculations.forEach(calc =>{
            ...
            document.getElementById("data-EQ-template").style.backgroundColor = "rgb(63, 252, 46)"
        })
    } 
        ...
        calculations.forEach(calc =>{
            ...
            document.getElementById("data-EQ-template").style.backgroundColor = "rgb(46, 252, 218)"
        })
        var result;
        valid = true;
